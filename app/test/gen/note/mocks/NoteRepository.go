...
import (
	...
	model "github.com/charmingruby/pack/internal/note/model"
...
func (_m *NoteRepository) Create(ctx context.Context, note model.Note) error {
...
func (_m *NoteRepository) FindByID(ctx context.Context, id string) (model.Note, error) {
...
func (_m *NoteRepository) List(ctx context.Context) ([]model.Note, error) {
	ret := _m.Called(ctx)
...
func (_m *NoteRepository) Save(ctx context.Context, note model.Note) error {
	ret := _m.Called(ctx, note)
